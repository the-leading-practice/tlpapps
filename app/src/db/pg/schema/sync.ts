...
export const syncSourceEnum = pgEnum('sync_source', ['ghl', 'drchrono', 'edge']);
...
export const syncDirectionEnum = pgEnum('sync_direction', ['drchrono_to_ghl', 'ghl_to_drchrono', 'drchrono_to_edge', 'edge_to_drchrono']);
