...
type LayoutRouteId = RouteId | "/(admin)" | "/(admin)/practice/config" | "/(admin)/practice/config/[slug]" | "/(admin)/practice/onboard" | "/(admin)/practice/settings" | "/(admin)/profile" | "/(admin)/profile/options"
