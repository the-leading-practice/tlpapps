...
export const formatTime = (time: string, timezone: string) => {
	const iso = new RegExp(/[0-9]{4}\-[0-9]{2}\-[0-9]{2}T[0-9]{2}\:[0-9]{2}\:[0-9]{2}\.[0-9]{3}Z/); // eslint-disable-line no-useless-escape
	const offset = new RegExp(
		/[0-9]{4}\-[0-9]{2}\-[0-9]{2}T[0-9]{2}\:[0-9]{2}\:[0-9]{2}[+-][0-9]{2}\:[0-9]{2}/, // eslint-disable-line no-useless-escape
	);
	const noTz = new RegExp(/[0-9]{4}\-[0-9]{2}\-[0-9]{2}[T ][0-9]{2}\:[0-9]{2}\:[0-9]{2}/); // eslint-disable-line no-useless-escape
